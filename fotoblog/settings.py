...
SECRET_KEY = 'django-insecure-q$=$$dx6$s!#5-wc34=ndbq@qix666--2-9pd_4*ulx-tjvrnr'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR.joinpath('templates'), # Ajout du répertoire de templates à la configuration
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
